...
button_buy = InlineKeyboardButton(text='первое', callback_data="product_buying")
button_buy2 = InlineKeyboardButton(text='второе', callback_data="product_buying")
button_buy3 = InlineKeyboardButton(text='третье', callback_data="product_buying")
button_buy4 = InlineKeyboardButton(text='еще что-то', callback_data="product_buying")
